...
class FSXMouseRect(bpy.types.PropertyGroup):
    name: bpy.props.StringProperty(name="Item", default="")


class MouseRectListItem(bpy.types.UIList):
    bl_idname = "MOUSERECT_UL_listItem"

    def draw_item(self, context, layout, data, item, icon, active_data, active_propname):
        layout.label(text=item.name)


bpy.utils.register_class(FSXMouseRect)
bpy.utils.register_class(MouseRectListItem)
