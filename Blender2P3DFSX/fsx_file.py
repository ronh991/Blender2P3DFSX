...
class GUIDGenerator(bpy.types.Operator):
    """Create new GUID"""
    bl_label = "Generate GUID"
    bl_idname = "fsx.guid_gen"
    bl_options = {'UNDO'}

    def execute(self, context):
        b = bytearray(urandom(16))
        b[6] = (b[6] & 0xf) | 0x40  # indicate that was generated at random
        self.newguid = '%02x%02x%02x%02x-%02x%02x-%02x%02x-%02x%02x-%02x%02x%02x%02x%02x%02x' % tuple(b)
        context.scene.fsx_guid = self.newguid
        self.report({'INFO'}, "New GUID generated...")
